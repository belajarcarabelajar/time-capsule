...
export default function UserBar() {
  ...
  const unlimitedQuota = user.unlimitedQuota === true;
  const pointsAvailable = unlimitedQuota || (user.pointsAvailable !== false && Number.isInteger(user.points) && Number.isInteger(user.maxPoints));
  const balanceLabel = unlimitedQuota ? 'Quota tanpa batas' : pointsAvailable ? `${user.points}/${user.maxPoints}` : 'Saldo belum tersedia';
